...
RUN apt-get update && \
    ...
    apt-get install -y binutils ca-certificates curl dbus locales openbox patch supervisor tigervnc-standalone-server tigervnc-tools tzdata --no-install-recommends && \
