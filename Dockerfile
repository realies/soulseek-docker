...
RUN apt-get update && \
    ...
    apt-get install -y binutils ca-certificates curl dbus locales openbox patch supervisor tigervnc-standalone-server tigervnc-common tigervnc-tools --no-install-recommends && \
